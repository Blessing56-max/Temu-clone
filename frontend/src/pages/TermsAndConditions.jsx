        ...
        <div className="space-y-8 text-onLight/65 text-sm leading-relaxed">
          <section>
            ...
            <p>
              ...
              details required to verify your account. Kora may suspend accounts found to contain
              false information.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              Product and vendor reviews must reflect a genuine transaction. Kora reserves the right
